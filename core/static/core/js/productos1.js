$(document).ready(function() {
    ...
    $('#id_nombre').attr('placeholder', 'Ej: Bicicleta, Accesorio, Partes');
    $('#id_descripcion').attr('placeholder', 'La Bicicleta Thunderbolt: ligera y ágil, ideal para aventuras rápidas. Con cuadro de aluminio, ruedas de carbono, frenos de disco hidráulicos y suspensión delantera ajustable para máximo rendimiento en cualquier terreno.');
    $('#id_precio').attr('placeholder', 'Ej: 435000');
