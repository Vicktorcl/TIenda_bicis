$(document).ready(function() {
  ...
  $('#id_username').attr('placeholder', 'Ej: cgomezv, vibarrientos, scavieres');
  $('#id_first_name').attr('placeholder', 'Ej: Cristián, Víctor, Sebastián');
  $('#id_last_name').attr('placeholder', 'Ej: Gómez Vega, Barrientos, Cavieres');
